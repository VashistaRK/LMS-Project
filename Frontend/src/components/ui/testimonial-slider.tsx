...
const TestimonialSlider: React.FC = () => {
  ...
  return (
    <div className="px-4 py-8 sm:py-16 bg-transparent overflow-hidden">
          ...
          <div className="flex justify-center sm:justify-end sm:absolute sm:-top-16 right-0 space-x-2 mb-4 sm:mb-0">
            <motion.button
              ...
              className={`p-2 rounded-full ${
                canGoPrev
                  ? 'bg-white/10 border border-white/20 shadow-md hover:bg-white/20 text-[#c0c1ff]'
          ...
          <div className="overflow-hidden relative px-2 sm:px-0">
            ...
            >
              {testimonials.map((testimonial) => (
                ...
                >
                  <motion.div
                    className="relative overflow-hidden rounded-xl sm:rounded-2xl p-4 sm:p-6 h-full bg-[rgba(24,24,27,0.6)] backdrop-blur-xl border border-white/[0.08] shadow-lg shadow-[#c0c1ff]/5"
                    whileHover={{
                  ...
                  >
                    ...
                    <div className="relative z-10 h-full flex flex-col">
                      <p className="text-sm sm:text-base text-zinc-300 font-medium mb-4 sm:mb-6 leading-relaxed">
                        ...
                        <div className="flex items-center">
                          <div className="relative flex-shrink-0">
                            <img
                              ...
                              onError={(e) => {
                                (e.target as HTMLImageElement).src = 'https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=48&h=48&fit=crop';
                              }}
                            />
                            <motion.div
                          ...
                          <div className="ml-3">
                            ...
                            <p className="text-zinc-400 text-xs sm:text-sm">{testimonial.username}</p>
                          </div>
                        </div>
                      </div>
                    </div>
